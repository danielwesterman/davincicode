This Mathematica code takes Leonardo Da Vinci pieces cut into vertical strips as an input (the strips can be out of order and/or rotated 180 degrees) and outputs the correct image.
